...
const _tmpl$ = /*#__PURE__*/template(`<style>.spinner-container {
  position: fixed;
  height: 100%;
  top: 0;
  left: 0;
...
customElement("my-counter", {
  ...
  return [_tmpl$.cloneNode(true), (() => {
    ...
    insert(_el$2, (() => {
      const _c$ = memo(() => !!props.type, true);

      return () => _c$() ? document.createElement(`${props.type}-spinner`) : document.createElement(`bar-spinner`);
    })());
