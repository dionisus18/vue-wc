...
(function(e) {
  ...
  class e extends HTMLElement {
    constructor() {
      super(), this.props = this.constructor.defaults, this.root = this.attachShadow({ mode: "open" });
    }
    connectedCallback() {
      this.update();
    }
    attributeChangedCallback(e2, i2, o2) {
      this.props[e2] = o2 || this.constructor.defaults[e2], this.update();
    }
    style() {
    ...
    `, i2 = this.template(this.props);
      this.root.innerHTML = `${e2}${i2}`;
    }
  }
  class i extends e {
    static get is() {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1, size: 60 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--atom-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--atom-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--atom-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .atom-spinner {
  ...
  class o extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 2, size: 65 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--breeding-rhombus-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--breeding-rhombus-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--breeding-rhombus-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class n extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", count: 3, duration: 1.2, size: 15 };
    }
    static get observedAttributes() {
      return ["color", "count", "duration", "size"];
    }
    get color() {
      return `var(--circles-to-rhombuses-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--circles-to-rhombuses-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--circles-to-rhombuses-spinner__size, ${this.props.size}px)`;
    }
    style({ count: e2 }) {
      const o2 = [];
      for (let n2 = 2; n2 <= e2; n2++)
        o2.push(`
        .circles-to-rhombuses-spinner .circle:nth-child(${n2}) {
          animation-delay: calc(${this.duration} / 8 * ${n2});
        }
      `);
      return `
      ...
      .circles-to-rhombuses-spinner {
        ...
        width: calc((${this.size} + ${this.size} * 1.125) * ${e2});
      }
  ...
  class d extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1.5, size: 64 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--fingerprint-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--fingerprint-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--fingerprint-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .fingerprint-spinner {
  ...
  class s extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 2.5, size: 70 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--flower-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--flower-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--flower-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .flower-spinner {
  ...
  class r extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 4, size: 50 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--fulfilling-bouncing-circle-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--fulfilling-bouncing-circle-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--fulfilling-bouncing-circle-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class z extends e {
    ...
    get color() {
      return `var(--fulfilling-square-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--fulfilling-square-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--fulfilling-square-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class u extends e {
    ...
    get color() {
      return `var(--half-circle-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--half-circle-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--half-circle-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .half-circle-spinner {
  ...
  class l extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", count: 3, duration: 1, size: 15 };
    }
    static get observedAttributes() {
      return ["color", "count", "duration", "size"];
    }
    get color() {
      return `var(--hollow-dots-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--hollow-dots-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--hollow-dots-spinner__size, ${this.props.size}px)`;
    }
    style({ count: e2 }) {
      const o2 = [];
      for (let n2 = 1; n2 <= e2; n2++)
        o2.push(`
        .hollow-dots-spinner .dot:nth-child(${n2}) {
          animation-delay: calc(${this.duration} / ${e2} * ${n2});
        }
      `);
      return `
      * {
  ...
  class f extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1.2, size: 35 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--intersecting-circles-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--intersecting-circles-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--intersecting-circles-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class c extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 2.5, size: 15 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--looping-rhombuses-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--looping-rhombuses-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--looping-rhombuses-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class p extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1.2, size: 55 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--orbit-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--orbit-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--orbit-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .orbit-spinner {
  ...
  class a extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 2, size: 70 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--pixel-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--pixel-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--pixel-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .pixel-spinner {
  ...
  class t extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 2, size: 60 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--radar-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--radar-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--radar-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .radar-spinner {
  ...
  class g extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1.25, size: 65 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--scaling-squares-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--scaling-squares-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--scaling-squares-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class h extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 6, size: 10 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--self-building-square-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--self-building-square-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--self-building-square-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class m extends e {
    ...
    get color() {
      return `var(--semipolar-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--semipolar-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--semipolar-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .semipolar-spinner {
  ...
  class b extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 3, size: 60 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--spring-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--spring-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--spring-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .spring-spinner {
  ...
  class w extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1, size: 65 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--swapping-squares-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--swapping-squares-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--swapping-squares-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class C extends e {
    ...
    static get defaults() {
      return { color: "#ff1d5e", duration: 1.5, size: 60 };
    }
    static get observedAttributes() {
      return ["color", "duration", "size"];
    }
    get color() {
      return `var(--trinity-rings-spinner__color, ${this.props.color})`;
    }
    get duration() {
      return `var(--trinity-rings-spinner__duration, ${this.props.duration}s)`;
    }
    get size() {
      return `var(--trinity-rings-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class y extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", height: 4, width: 100 };
    }
    static get observedAttributes() {
      return ["color", "height", "width"];
    }
    get color() {
      return `var(--bar-spinner__color, ${this.props.color})`;
    }
    get height() {
      return `var(--bar-spinner__height, ${this.props.height}px)`;
    }
    get width() {
      return `var(--bar-spinner__width, ${this.props.width}px)`;
    }
    style() {
      return `
      .bar-spinner {
  ...
  class A extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", margin: 2, size: 15 };
    }
    static get observedAttributes() {
      return ["color", "margin", "size"];
    }
    get color() {
      return `var(--beat-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--beat-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--beat-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .beat {
  ...
  class L extends e {
    static get is() {
      return "bounce-spinner";
    }
    static get defaults() {
      return { color: "#36d7b7", size: 60 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--bounce-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--bounce-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .bounce-spinner {
  ...
  class S extends e {
    ...
    get color() {
      return `var(--circle-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--circle-spinner__size, ${this.props.size}px)`;
    }
    calculateCircle(e2) {
      return `
      animation-delay: ${-0.2 * e2}s;
      height: calc(${this.size} * ${1 - e2 / 10});
      left: ${2.5 * (0.7 * e2)}%;
      top: ${2.5 * (0.35 * e2)}%;
      width: calc(${this.size} * ${1 - e2 / 10});
    `;
    }
    style() {
      return `
  ...
  class k extends e {
    static get is() {
      return "climbing-box-spinner";
    }
    static get defaults() {
      return { color: "#36d7b7", size: 15 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--climbing-box-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--climbing-box-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
  ...
  class v extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", size: 35 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--clip-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--clip-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .clip-spinner {
  ...
  class q extends e {
    ...
    get color() {
      return `var(--dot-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--dot-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .dot-spinner {
  ...
  class D extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", height: 15, radius: 10, width: 5 };
    }
    static get observedAttributes() {
      return ["color", "height", "radius", "width"];
    }
    get color() {
      return `var(--fade-spinner__color, ${this.props.color})`;
    }
    get height() {
      return `var(--fade-spinner__height, ${this.props.height}px)`;
    }
    get radius() {
      return `var(--fade-spinner__radius, ${this.props.radius}px)`;
    }
    get width() {
      return `var(--fade-spinner__width, ${this.props.width}px)`;
    }
    get center() {
      return `calc(${this.radius} + ${this.height})`;
    }
    buildLine(e2) {
      return `
      .container:nth-child(${e2}) { transform: rotate(${45 * (e2 - 1)}deg); }
      .container:nth-child(${e2}) .line { animation-delay: calc(${e2 - 1} * .12s); }
    `;
    }
    style() {
      return `
  ...
  class j extends e {
    ...
    get color() {
      return `var(--grid-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--grid-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--grid-spinner__size, ${this.props.size}px)`;
    }
    generateCellAnimation() {
      const e2 = Math.random();
      return `
      animation-duration: ${e2 + 0.6}s;
      animation-delay: ${e2 - 0.2}s;
    `;
    }
    style() {
      return `
  ...
  class x extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", size: 50 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--hash-spinner__color, ${this.props.color})`;
    }
    get lat() {
      return `calc(calc(${this.size} - ${this.thickness}) / 2)`;
    }
    get offset() {
      return `calc(${this.lat} - ${this.thickness})`;
    }
    get size() {
      return `var(--hash-spinner__size, ${this.props.size}px)`;
    }
    get thickness() {
      return `calc(${this.size} / 5)`;
    }
    style() {
      return `
      .hash-spinner {
  ...
  class H extends e {
    ...
    get color() {
      return `var(--moon-spinner__color, ${this.props.color})`;
    }
    get moonSize() {
      return `calc(${this.size} / 7)`;
    }
    get size() {
      return `var(--moon-spinner__size, ${this.props.size}px)`;
    }
    ballStyle(e2) {
      return `
      border-radius: 100%;
  ...
  class M extends e {
    static get is() {
      return "pacman-spinner";
    }
    static get defaults() {
      return { color: "#36d7b7", margin: 2, size: 25 };
    }
    static get observedAttributes() {
      return ["color", "margin", "size"];
    }
    get color() {
      return `var(--pacman-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--pacman-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--pacman-spinner__size, ${this.props.size}px)`;
    }
    ballDelay(e2) {
      return `animation-delay: ${0.25 * e2}s;`;
    }
    style() {
      return `
      .pacman-spinner {
  ...
  class T extends e {
    ...
    get color() {
      return `var(--propagate-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--propagate-spinner__size, ${this.props.size}px)`;
    }
    style() {
      const e2 = [1, 3, 5];
      return `
      ...
      @keyframes ball1 {
        25% { transform: translateX(-${e2[0]}rem) scale(0.75); }
        50% { transform: translateX(-${e2[1]}rem) scale(0.6); }
        75% { transform: translateX(-${e2[2]}rem) scale(0.5); }
      ...
      @keyframes ball2 {
        25% { transform: translateX(-${e2[0]}rem) scale(0.75); }
        50% { transform: translateX(-${e2[1]}rem) scale(0.6); }
        75% { transform: translateX(-${e2[1]}rem) scale(0.6); }
        95% { transform: translateX(0rem)               scale(1); }
      }

      @keyframes ball3 {
        25% { transform: translateX(-${e2[0]}rem) scale(0.75); }
        75% { transform: translateX(-${e2[0]}rem) scale(0.75); }
        95% { transform: translateX(0rem)               scale(1); }
      }
  ...
  class I extends e {
    ...
    get color() {
      return `var(--pulse-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--pulse-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--pulse-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .pulse-spinner {
  ...
  class J extends e {
    ...
    get color() {
      return `var(--ring-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--ring-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .ring-spinner {
  ...
  class K extends e {
    ...
    get color() {
      return `var(--rise-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--rise-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--rise-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .ball {
  ...
  class E extends e {
    static get is() {
      return "rotate-spinner";
    }
    static get defaults() {
      return { color: "#36d7b7", margin: 5, size: 15 };
    }
    static get observedAttributes() {
      return ["color", "margin", "size"];
    }
    get color() {
      return `var(--rotate-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--rotate-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--rotate-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .rotate-spinner {
  ...
  class F extends e {
    static get is() {
      return "scale-spinner";
    }
    static get defaults() {
      return { color: "#36d7b7", height: 35, margin: 2, radius: 2, width: 4 };
    }
    static get observedAttributes() {
      return ["color", "height", "margin", "radius", "width"];
    }
    get color() {
      return `var(--scale-spinner__color, ${this.props.color})`;
    }
    get height() {
      return `var(--scale-spinner__height, ${this.props.height}px)`;
    }
    get margin() {
      return `var(--scale-spinner__margin, ${this.props.margin}px)`;
    }
    get radius() {
      return `var(--scale-spinner__radius, ${this.props.radius}px)`;
    }
    get width() {
      return `var(--scale-spinner__width, ${this.props.width}px)`;
    }
    get size() {
      return `var(--scale-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .scale-spinner {
  ...
  class N extends e {
    ...
    static get defaults() {
      return { color: "#36d7b7", size: 20 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--skew-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--skew-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .skew-spinner {
  ...
  class O extends e {
    ...
    get color() {
      return `var(--square-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--square-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .square-spinner {
  ...
  class P extends e {
    ...
    get color() {
      return `var(--sync-spinner__color, ${this.props.color})`;
    }
    get margin() {
      return `var(--sync-spinner__margin, ${this.props.margin}px)`;
    }
    get size() {
      return `var(--sync-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .sync-spinner {
  ...
  class Q extends e {
    static get is() {
      return "rsc-circle-spinner";
    }
    static get defaults() {
      return { color: "#7f58af", size: 64 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--rsc-circle-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--rsc-circle-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-circle {
  ...
  class R extends e {
    ...
    static get defaults() {
      return { color: "#7f58af", size: 80 };
    }
    static get observedAttributes() {
      return ["color", "size"];
    }
    get color() {
      return `var(--default-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--default-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-default {
  ...
  class G extends e {
    ...
    get color() {
      return `var(--dual-ring-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--dual-ring-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-dual-ring {
  ...
  class _ extends e {
    ...
    get color() {
      return `var(--ellipsis-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--ellipsis-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-ellipsis {
  ...
  class U extends e {
    ...
    get color() {
      return `var(--facebook-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--facebook-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-facebook {
  ...
  class V extends e {
    ...
    get color() {
      return `var(--rsc-grid-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--rsc-grid-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-grid {
  ...
  class W extends e {
    ...
    get color() {
      return `var(--heart-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--heart-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-heart {
  ...
  class X extends e {
    ...
    get color() {
      return `var(--hourglass-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--hourglass-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-hourglass {
  ...
  class Y extends e {
    ...
    get color() {
      return `var(--orbitals-spinner__color, ${this.props.color})`;
    }
    style() {
      return `
      .lds-orbitals {
  ...
  class Z extends e {
    ...
    get color() {
      return `var(--ouroboro-spinner__color, ${this.props.color})`;
    }
    style() {
      return `
      .lds-ouroboro {
  ...
  class $ extends e {
    ...
    get color() {
      return `var(--rsc-ring-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--rsc-ring-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-ring {
  ...
  class B extends e {
    ...
    get color() {
      return `var(--ripple-spinner__color, ${this.props.color})`;
    }
    get size() {
      return `var(--ripple-spinner__size, ${this.props.size}px)`;
    }
    style() {
      return `
      .lds-ripple {
  ...
  class ee extends e {
    ...
    get color() {
      return `var(--roller-spinner__color, ${this.props.color})`;
    }
    style() {
      return `
      .lds-roller {
  ...
  customElements.define(ee.is, ee);
  class ie extends e {
    static get is() {
    ...
    get color() {
      return `var(--spinner-spinner__color, ${this.props.color})`;
    }
    style() {
      return `
      .lds-spinner {
...
class MySpinner extends LitElement {
  constructor() {
    super();
    this.disabled = false;
    this.type = "atom";
...
__publicField(MySpinner, "styles", css`
    .spinner-container {
      position: fixed;
      height: 100%;
      top: 0;
